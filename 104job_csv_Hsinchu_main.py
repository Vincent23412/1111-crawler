...
class JobScraper:
    def __init__(self):
        ...
        self.job_codes = {
            ...
            "星象占卜人員": "2018002004", 
            "禮賓接待人員": "2002001013", # 以下是104新增職業 (24個, August, 2025)
            "產品經理": "2004003009",
            "品牌經理": "2004001021",
            "內容行銷人員": "2004001022",
            "網紅行銷人員": "2004001023",
    ...
    def generate_metadata_summary(self):
        ...
        for job_name, job_code in self.all_job_codes.items():
            summary[job_name] = {}
    ...
    def run(self):
        finish_list = self._get_finish_list()

        for city_name, city_code in self.city_codes.items():
            all_jobs = []

            for job_name, job_code in self.job_codes.items():
                if job_name in finish_list:
                    logging.info(f"Skipping {city_name} - {job_name} as it is already processed.")
                    continue
